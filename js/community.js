        ...
        postElement.innerHTML = `
          ...
          <div class="postComments">
            <div class="newPost">
              ...
              <button class="newCommentBtn" data-post-id="${post.id}">تعليق</button>
            </div>
            ${commentsHTML}
          </div>
        `;
...
function setupEventListeners(category) {
  ...
  submitPostBtn.addEventListener('click', function() {
    ...
    if (title && question) {
      ...
      // Create a unique ID for the new post (would be handled by backend in real app)
      ...
      newPost.innerHTML = `
        ...
        <div class="postComments">
          <div class="newPost">
            <input class="commentInputField" type="text" placeholder="أضف تعليقك هنا..." />
            <button class="newCommentBtn" data-post-id="${newPostId}">تعليق</button>
          </div>
        </div>
      `;
      ...
      // Setup the comment button for the new post
      setupCommentButtons();
    }
  });
}